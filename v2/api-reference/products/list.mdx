...
```json Response
{
    ...
    "first_page_url": "https://pay.chargily.io/test/api/v2/products?page=1",
    "last_page": 4,
    "last_page_url": "https://pay.chargily.io/test/api/v2/products?page=4",
    "next_page_url": "https://pay.chargily.io/test/api/v2/products?page=2",
    "path": "https://pay.chargily.io/test/api/v2/products",
    "per_page": 2,
    "prev_page_url": null,
    "total": 7
}
